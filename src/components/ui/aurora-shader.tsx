...
/**
 * Fondo aurora animado (three.js). Recoloreado al morado de marca.
 * Se ajusta al contenedor y limita el pixel ratio por rendimiento.
 */
        ...
        void main() {
          ...
          for (float i = 0.0; i < 24.0; i++) {
            ...
            vec4 auroraColors = vec4(
              ...
              0.16 + 0.18 * cos(i * 0.3 + iTime * 0.5),
              0.78 + 0.22 * sin(i * 0.4 + iTime * 0.3),
              1.0
            );
